...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo base_url(); ?>tampilan_utama" class="logo">
      ...
      <span class="logo-lg"><b>Zic</b>Speed</span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li>
            <?php echo anchor('auth/logout', '<i class="fa fa-sign-out"> Sign Out </i>'); ?>
          </li>
        </ul>
      </div>
    </nav>
  ...
  <footer class="main-footer">
    ...
    <strong>SKRIPSI Yunita Rustania | Sistem Informasi Akademik SMA Adi Luhur Jakarta</strong>
  </footer>
      <!-- Control Sidebar 
