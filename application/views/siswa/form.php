...
<body>
  ...
  if(isset($_POST['preview'])){ // Jika user menekan tombol Preview pada form 
    ...
    foreach($sheet as $row){ 
      ...
      $jenis_kelamin =$get[2];
      $tanggal_lahir = $get[3]; // Ambil data Tanggal Lahir
      
      // Cek jika semua data tidak diisi
      if(empty($nis) && empty($nama) && empty($jenis_kelamin) && empty($tanggal_lahir))
      ...
      if($numrow > 1){
        ...
        $jenis_kelamin__td = ( ! empty($jenis_kelamin))? "" : " style='background: #E07171;'";
        $tanggal_lahir_td = ( ! empty($tanggal_lahir))? "" : " style='background: #E07171;'"; // Jika Tanggal Lahir kosong, beri warna merah

        // Jika salah satu data ada yang kosong
        if(empty($nis) or empty($nama) or empty($jenis_kelamin) or empty($tanggal_lahir)){
        ...
        echo "<td".$jenis_kelamin__td.">".$jenis_kelamin."</td>";
