		...
		function data()
		{
			...
			$columns    = array(
		        ...
		        array(
		              ...
		              'dt' => 'aksi',
		              'formatter' => function($d) {
		               		return anchor('menu/edit/'.$d, '<i class="fa fa-edit" style="margin-right:5px"></i>').' 
		               		'.anchor('menu/delete/'.$d, '<i class="fa fa-times" style="color:red"></i>',array('onclick' => "return confirm('Do you want delete this record')") );
		            }
		        )
		    );
