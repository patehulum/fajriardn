		...
		function data()
		{
			...
			$columns    = array(
		        ...
		        array(
		              ...
		              'dt' => 'aksi',
		              'formatter' => function($d) {
		               		return anchor('tahunakademik/aktif/'.$d, 'Ubah Aktif', 'class="btn btn-xs bg-orange" data-placement="top" title="Aktif"').'
		               		'.anchor('tahunakademik/edit/'.$d, '<i class="fa fa-edit" style="margin-right:5px"></i>').'
		               		'.anchor('tahunakademik/delete/'.$d, '<i class="fa fa-times" style="color:red"></i>',array('onclick' => "return confirm('Do you want delete this record')") );
		            }
		        )
		    );
