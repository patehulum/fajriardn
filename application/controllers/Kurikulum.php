		...
		function data()
		{
			...
			$columns    = array(
		        ...
		        array(
		              ...
		              'dt' => 'aksi',
		              'formatter' => function($d) {
		               		return anchor('kurikulum/detail/'.$d, '<i class="fa fa-eye" style="margin-right:5px"></i>').'
                      '.anchor('kurikulum/edit/'.$d, '<i class="fa fa-edit" style="margin-right:5px"></i>').'
		               		'.anchor('kurikulum/delete/'.$d, '<i class="fa fa-times" style="color:red"></i>', array('onclick' => "return confirm('Do you want delete this record')") );
		            }
		        )
		    );
