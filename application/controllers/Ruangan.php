	...
	class Ruangan extends CI_Controller
	{
		...
		function data()
		{
			...
			$columns    = array(
		        ...
		        array('db' => 'kapasitas', 'dt' => 'kapasitas'),
		        //untuk menampilkan aksi(edit/delete dengan parameter kode ruangan)
		        array(
		              'db' => 'kd_ruangan',
		              'dt' => 'aksi',
		              'formatter' => function($d) {
		               		return anchor('ruangan/edit/'.$d, '<i class="fa fa-edit" style="margin-right:5px"></i>').' 
		               		'.anchor('ruangan/delete/'.$d,'<i class="fa fa-times" style="color:red"></i>',array('onclick' => "return confirm('Do you want delete this record')") );
		            }
		        )
		    );
