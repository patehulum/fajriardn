		...
		function data()
		{
			...
			$columns    = array(
		        ...
		        array(
		              ...
		              'dt' => 'aksi',
		              'formatter' => function($d) {
		               		return anchor('user/edit/'.$d, '<i class="fa fa-edit" style="margin-right:5px"></i>').' 
		               		'.anchor('user/delete/'.$d, '<i class="fa fa-times" style="color:red"></i>',array('onclick' => "return confirm('Do you want delete this record')") );
		            }
		        )
		    );
