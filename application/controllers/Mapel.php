			...
			$columns    = array(
		        ...
		        array(
		              ...
		              'formatter' => function($d) {
		               		return anchor('mapel/edit/'.$d, '<i class="fa fa-edit" style="margin-right:5px"></i>').' 
		               		'.anchor('mapel/delete/'.$d,'<i class="fa fa-times" style="color:red"></i>',array('onclick' => "return confirm('Do you want delete this record')") );
		            }
		        )
		    );
